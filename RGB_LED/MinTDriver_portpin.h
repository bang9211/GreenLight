...
void exportGPIO(int gpioNum){
    char systemCommand[50] = "echo ";
    char systemCommand2[50] = " > /sys/class/gpio/export";
    char gpioNumber[5];
    
    sprintf(gpioNumber,"%d",gpioNum);
    
    strcat(systemCommand,gpioNumber);
    strcat(systemCommand,systemCommand2);
...
void setPWM(int portNum, int pinNum){
    char systemCommand[50] = "echo bone_pwm_";
    char overlayPath[40] = " > /sys/devices/bone_capemgr.9/slots";
    char p[4] = "P";
    char underBar[2] = "_";
    char port[4];
